...
summary: Configure Citrix Hypervisor 8.4 para rutas múltiples y con parámetros y configuraciones específicos para operaciones de protocolo FCP e iSCSI con almacenamiento ONTAP . 
---
...
[role="lead"]
Configure Citrix Hypervisor 8.4 para rutas múltiples y con parámetros y configuraciones específicos para operaciones de protocolo FCP e iSCSI con almacenamiento ONTAP .
...
Puede utilizar rutas múltiples con Citrix Hypervisor 8.4 para administrar LUN de ONTAP .
