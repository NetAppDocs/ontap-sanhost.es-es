...
NOTE: Para configurar Oracle Linux 6,6 Red Hat Enterprise Kernel (RHCK), utilice para link:hu_rhel_66.html#recommended-settings["configuración recomendada"]Red Hat Enterprise Linux (RHEL) 6,6.
