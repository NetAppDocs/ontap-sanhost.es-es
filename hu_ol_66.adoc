...
---
= Utilice Oracle Linux 6,6 con ONTAP
:hardbreaks:
:toclevels: 1
:allow-uri-read: 
:toclevels: 1
...
[role="lead"]
Es posible usar las opciones de configuración del host SAN de ONTAP para configurar Oracle Linux 6,6 con ONTAP como destino.
...
NOTE: Para configurar el kernel compatible con Red Hat (RHCK) de Oracle Linux 6,6, utilice para link:hu_rhel_66.html#recommended-settings["configuración recomendada"]Red Hat Enterprise Linux (RHEL) 6,6.
...
No existen problemas conocidos para la versión Oracle Linux 6,6 con ONTAP.


NOTE: Para obtener información sobre problemas conocidos de Oracle Linux RHCK, consulte link:hu_rhel_66.html#known-problems-and-limitations["problemas conocidos"]para RHEL 6,6.
