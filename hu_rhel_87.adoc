...
---
= Uso de Red Hat Enterprise Linux 8.7 con ONTAP de NetApp
:toc: macro
:hardbreaks:
:toclevels: 1
:allow-uri-read: 
...
El sistema operativo RHEL 8.7 se compila para reconocer las LUN de ONTAP y establecer automáticamente todos los parámetros de configuración correctamente para las configuraciones ASA y no ASA.
