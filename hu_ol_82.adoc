...
NOTE: Para problemas conocidos de Oracle Linux (kernel compatible con Red Hat), consulte link:hu_rhel_82.html#known-problems-and-limitations["problemas conocidos"]para Red Hat Enterprise Linux (RHEL) 8,2.
