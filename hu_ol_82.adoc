...
---
= Uso de Oracle Linux 8.2 con NetApp ONTAP
:toc: macro
:hardbreaks:
:toclevels: 1P
:allow-uri-read: 
...
NOTE: Para configurar Oracle Linux 8.2 RedHat Enterprise Kernel (RHCK), utilice link:hu_rhel_82.html#recommended-settings["configuración recomendada"] Para Red Hat Enterprise Linux (RHEL) 8.2.



== Problemas y limitaciones conocidos

No existen problemas conocidos para Oracle Linux 8.2.
