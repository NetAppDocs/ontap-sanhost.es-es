...
NOTE: Para configurar el kernel compatible con Red Hat (RHCK) de Oracle Linux 8,2, utilice para link:hu_rhel_82.html#recommended-settings["configuración recomendada"]Red Hat Enterprise Linux (RHEL) 8,2.
...
NOTE: Para obtener información sobre problemas conocidos de Oracle Linux RHCK, consulte link:hu_rhel_82.html#known-problems-and-limitations["problemas conocidos"]para RHEL 8,2.
