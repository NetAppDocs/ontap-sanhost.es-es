...
NOTE: Para configurar el kernel compatible con Red Hat (RHCK) de Oracle Linux 8,0, utilice para link:hu_rhel_80.html#recommended-settings["configuración recomendada"]Red Hat Enterprise Linux (RHEL) 8,0.
...
NOTE: Para obtener información sobre problemas conocidos de Oracle Linux RHCK, consulte link:hu_rhel_80.html#known-problems-and-limitations["problemas conocidos"]para RHEL 8,0.
