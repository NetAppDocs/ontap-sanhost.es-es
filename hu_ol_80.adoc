...
NOTE: Para configurar Oracle Linux 8.0 RedHat Enterprise Kernel (RHCK), utilice link:hu_rhel_80.html#recommended-settings["configuración recomendada"] Para Red Hat Enterprise Linux (RHEL) 8.0.
