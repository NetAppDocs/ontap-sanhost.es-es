...
.Pasos
. Instale RHEL 8,9 en el servidor host.
. Una vez finalizada la instalación, compruebe que está ejecutando el kernel de RHEL 8,9 especificado:
+
[listing]
----
# uname -r
...
--
.Pasos
. El controlador de la bandeja de entrada nativa qla2xxx que se incluye en el kernel GA de RHEL 8,9 tiene las correcciones previas más recientes esenciales para admitir ONTAP. Compruebe que está ejecutando las versiones de firmware y controlador del adaptador compatibles:
+
[listing]
----
