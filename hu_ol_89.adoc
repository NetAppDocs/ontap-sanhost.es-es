...
NOTE: Para configurar el kernel compatible con Red Hat (RHCK) de Oracle Linux 8,9, utilice para link:hu_rhel_89.html#recommended-settings["configuración recomendada"]Red Hat Enterprise Linux (RHEL) 8,9.
