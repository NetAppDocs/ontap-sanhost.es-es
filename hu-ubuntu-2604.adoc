...
summary: Instala las utilidades de host de Linux en un host Ubuntu 26.04 para gestionar las operaciones de los protocolos FCP e iSCSI con los LUN de ONTAP. 
---
= Configurar Ubuntu 26.04 para FCP e iSCSI con almacenamiento ONTAP
:hardbreaks:
:toclevels: 1
:allow-uri-read: 
:toclevels: 1
...
[role="lead"]
El software Linux Host Utilities proporciona herramientas de gestión y diagnóstico para hosts Linux conectados al almacenamiento ONTAP. Cuando instalas Linux Host Utilities en un host Ubuntu 26.04, puedes usar las utilidades para ayudarte a gestionar las operaciones de los protocolos FCP e iSCSI con los LUN de ONTAP.
...
Puedes utilizar multipathing con Ubuntu 26.04 para gestionar los LUN de ONTAP.
