...
summary: Describe cómo usar Oracle Linux 6.10 con ONTAP 
---
= Uso de Oracle Linux 6.10 con NetApp ONTAP
:toc: macro
:hardbreaks:
:toclevels: 1
:allow-uri-read: 
...
Para Oracle Linux 6.10 debe existir el archivo /etc/multipath.conf, pero no es necesario realizar cambios específicos en el archivo. Oracle Linux 6.10 se ha compilado con todas las configuraciones necesarias para reconocer y gestionar correctamente las LUN de ONTAP. Para habilitar ALUA Handler, realice los siguientes pasos:
...
El sistema operativo Oracle Linux 6.10 se compila para reconocer las LUN de ONTAP y establecer automáticamente todos los parámetros de configuración correctamente.
...
NOTE: Para configurar Oracle Linux 6.10 RedHat Enterprise Kernel (RHCK), utilice link:hu_rhel_610.html#recommended-settings["configuración recomendada"] Para Red Hat Enterprise Linux (RHEL) 6.10.



== Problemas y limitaciones conocidos

No hay problemas conocidos de Oracle 6.10.


NOTE: Para ver los problemas conocidos de Oracle Linux (kernel compatible con Red Hat), consulte link:hu_rhel_610.html#known-problems-and-limitations["problemas conocidos"] Para Red Hat Enterprise Linux (RHEL) 6.10.
