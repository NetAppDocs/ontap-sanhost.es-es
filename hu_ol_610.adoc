...
NOTE: Para configurar el kernel compatible con Red Hat (RHCK) de Oracle Linux 6,10, utilice para link:hu_rhel_610.html#recommended-settings["configuración recomendada"]Red Hat Enterprise Linux (RHEL) 6,10.
...
NOTE: Para obtener información sobre problemas conocidos de Oracle Linux RHCK, consulte link:hu_rhel_610.html#known-problems-and-limitations["problemas conocidos"]para RHEL 6,10.
