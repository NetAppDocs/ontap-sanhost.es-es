...
summary: Instale las utilidades de host de Linux en un host RHEL 10.x para administrar las operaciones de protocolo FCP e iSCSI con LUN de ONTAP . 
---
= Configurar RHEL 10.x para FCP e iSCSI con almacenamiento ONTAP
:hardbreaks:
:toclevels: 1
:allow-uri-read: 
:toclevels: 1
...
Puedes utilizar multipathing con RHEL 10.x para gestionar LUN de ONTAP .
