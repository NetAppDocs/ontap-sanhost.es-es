...
---
= Uso de Oracle Linux 9,2 con NetApp ONTAP
:toc: macro
:hardbreaks:
:toclevels: 1P
:allow-uri-read: 
...
NOTE: Para configurar Oracle Linux 9,2 RedHat Enterprise Kernel (RHCK), utilice link:hu_rhel_91.html#recommended-settings["configuración recomendada"] Para Red Hat Enterprise Linux (RHEL) 9,2.
...
Oracle Linux 9,2 con la versión NetApp ONTAP tiene los siguientes problemas conocidos:
