...
* No hay compatibilidad de sanlun para NVMe-oF. Por lo tanto, la compatibilidad con la utilidad host no está disponible para NVMe-oF en un host SUSE Linux Enterprise Server 15 SP5. Es posible usar el plugin de NetApp incluido en el paquete nvme-cli nativo para todos los transportes NVMe-oF.
