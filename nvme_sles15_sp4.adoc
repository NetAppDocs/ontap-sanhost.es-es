...
--
.Pasos
. El controlador de la bandeja de entrada nativa qla2xxx incluido en el kernel SLES 15 SP4 tiene las últimas correcciones esenciales para la compatibilidad con ONTAP. Compruebe que está ejecutando las versiones de firmware y controlador del adaptador compatibles:
+
[listing]
----
...
Es posible usar el siguiente procedimiento para habilitar los servicios NVMe.
...
----
. Genere la clave dhchap para el host SLES15 SP4:
+
[listing]
----
...
Puede generar el archivo JSON con `-o` opción. Consulte la link:https://docs.netapp.com/us-en/ontap/concepts/manual-pages.html["Páginas manuales de ONTAP"^] para obtener más opciones de sintaxis.
