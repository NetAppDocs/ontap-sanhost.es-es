...
Aprenda a configurar hosts NVMe over Fabrics (NVMe-oF) para Rocky Linux 9.4. Para obtener más información sobre asistencia y funciones, consulte link:nvme-rockylinux-supported-features.html["Compatibilidad y características de Rocky Linux ONTAP"].

NVMe-oF con Rocky Linux 9.4 no tiene limitaciones conocidas.
