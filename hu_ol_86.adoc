...
NOTE: Para configurar Oracle Linux 8,6 Red Hat Enterprise Kernel (RHCK), utilice para link:hu_rhel_86.html#recommended-settings["configuración recomendada"]Red Hat Enterprise Linux (RHEL) 8,6.
...
No existen problemas conocidos para la versión Oracle Linux 8,6 con ONTAP.
