...
NOTE: Para obtener información sobre problemas conocidos de Oracle Linux (kernel compatible con Red Hat), consulte link:hu_rhel_86.html#known-problems-and-limitations["problemas conocidos"]la sección en la documentación de la versión de Red Hat Enterprise Linux correspondiente.
