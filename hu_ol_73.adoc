...
El sistema operativo Oracle Linux 7,3 se compila para reconocer los LUN de ONTAP y definir automáticamente todos los parámetros de configuración correctamente.
