...
NOTE: Para configurar Oracle Linux 7.3 RedHat Enterprise Kernel (RHCK), utilice link:hu_rhel_73.html#recommended-settings["configuración recomendada"] Para Red Hat Enterprise Linux (RHEL) 7.3.
