...
---
= Referencia de comandos de ejemplo de AIX Host Utilities 6,1
:hardbreaks:
:toclevels: 1
:allow-uri-read: 
:toclevels: 1
...
[role="lead"]
Puede usar la referencia de comando de muestra de AIX Host Utilities 6,1 para una validación integral de la configuración del almacenamiento NetApp con la herramienta de utilidades de host.
