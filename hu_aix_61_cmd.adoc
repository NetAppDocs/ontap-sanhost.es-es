...
summary: Puede usar la referencia de comando de muestra de AIX Host Utilities para una validación integral de la configuración del almacenamiento de NetApp con la herramienta de utilidades de host. 
---
...
[role="lead"]
Puede usar la referencia de comando de muestra de AIX Host Utilities para una validación integral de la configuración del almacenamiento de NetApp con la herramienta de utilidades de host.
