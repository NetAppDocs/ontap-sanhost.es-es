...
[role="lead"]
Puede utilizar la referencia de comando AIX Host Utilities 6,1 para realizar una validación integral de la configuración del almacenamiento NetApp con la herramienta de utilidades de host.
