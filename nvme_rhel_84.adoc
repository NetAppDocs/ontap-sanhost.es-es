...
--
La bandeja de entrada nativa `qla2xxx` El controlador que se incluye en el kernel GA de RHEL 8,4 tiene las últimas correcciones esenciales para la compatibilidad con ONTAP.
