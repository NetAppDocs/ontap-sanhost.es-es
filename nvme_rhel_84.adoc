...
* NVMe/TCP en RHEL 8.4 sigue siendo una función de vista previa de la tecnología debido a problemas abiertos. Consulte la https://["Notas de la versión de RHEL 8.4"^] para obtener más detalles.
