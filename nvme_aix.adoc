...
Antes de solucionar problemas de cualquier fallo NVMe/FC, compruebe que ejecuta una configuración que cumpla con las especificaciones de IMT.
Si sigue teniendo problemas, póngase en contacto con el soporte técnico para obtener más información.
