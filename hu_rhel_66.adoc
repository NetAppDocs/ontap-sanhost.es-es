...
| link:https://mysupport.netapp.com/NOW/cgi-bin/bol?Type=Detail&Display=863878["863878"^] | Se produce un bloqueo del kernel con el host RHEL 6U6 durante errores de almacenamiento | Es posible que observe un bloqueo del kernel en el host RHEL 6U6 durante la estructura de almacenamiento/. 


| link:https://mysupport.netapp.com/NOW/cgi-bin/bol?Type=Detail&Display=852674["1076584"^] | El I/o se estancó hasta 300 segundos en el host QLE2672 (QLE2672) de QLogic durante los errores de almacenamiento en RHEL 6U4 | Es posible que observe que el I/o se ha calado en hasta 300 s en el host QLE2672 (QLogic 16G FC (QLE2672) durante errores de almacenamiento o la estructura. 
