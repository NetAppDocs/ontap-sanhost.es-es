...
---
= Uso de Oracle Linux 7.1 con NetApp ONTAP
:toc: macro
:hardbreaks:
:toclevels: 1
:allow-uri-read: 
...
NOTE: Para configurar Oracle Linux 7.1 RedHat Enterprise Kernel (RHCK), utilice link:hu_rhel_71.html#recommended-settings["configuración recomendada"] Para Red Hat Enterprise Linux (RHEL) 7.1.



== Problemas y limitaciones conocidos

No existen problemas conocidos para Oracle Linux 7.1.
