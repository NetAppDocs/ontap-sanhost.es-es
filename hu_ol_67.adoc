...
summary: Describe cómo usar Oracle Linux 6.7 con ONTAP 
---
= Uso de Oracle Linux 6.7 con NetApp ONTAP
:toc: macro
:hardbreaks:
:toclevels: 1
:allow-uri-read: 
...
El sistema operativo Oracle Linux 6.7 se compila para reconocer las LUN de ONTAP y establecer automáticamente todos los parámetros de configuración correctamente.
...
NOTE: Para configurar Oracle Linux 6.7 RedHat Enterprise Kernel (RHCK), utilice link:hu_rhel_67.html#recommended-settings["configuración recomendada"] Para Red Hat Enterprise Linux (RHEL) 6.7.



== Problemas y limitaciones conocidos

No hay problemas conocidos de Oracle 6.7.


NOTE: Para ver los problemas conocidos de Oracle Linux (kernel compatible con Red Hat), consulte link:hu_rhel_67.html#known-problems-and-limitations["problemas conocidos"] Para Red Hat Enterprise Linux (RHEL) 6.7.
