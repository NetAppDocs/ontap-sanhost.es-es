...
Si continúa teniendo problemas, recopile los siguientes archivos y salidas de comandos y comuníquese con link:mysupport.netapp.com["Soporte de NetApp"^] Para mayor triaje:
