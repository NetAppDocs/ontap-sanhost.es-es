...
---
= Uso de Red Hat Enterprise Linux 8.2 con ONTAP de NetApp
:toc: macro
:hardbreaks:
:toclevels: 1
:allow-uri-read: 
...
Para Red Hat Enterprise Linux (RHEL) 8.2 debe existir el archivo /etc/multipath.conf, pero no es necesario realizar cambios específicos en el archivo. RHEL 8.2 se ha compilado con todas las configuraciones necesarias para reconocer y gestionar correctamente las LUN de ONTAP.
...
No hay problemas conocidos para RHEL 8.2.
