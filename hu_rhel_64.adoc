...
---
= Utilice Red Hat Enterprise Linux 6,4 con ONTAP
:hardbreaks:
:toclevels: 1
:allow-uri-read: 
:toclevels: 1
...
[role="lead"]
Puede utilizar los ajustes de configuración del host SAN de ONTAP para configurar Red Hat Enterprise Linux 6,4 con ONTAP como destino.
...
La versión de RHEL 6,4 con ONTAP tiene los siguientes problemas conocidos:
