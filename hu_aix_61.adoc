...
+
Puede utilizar el https://["Herramienta de matriz de interoperabilidad de NetApp"^] para verificar la configuración.
...
El paquete de software AIX Host Utilities de NetApp está disponible en la https://["Sitio de soporte de NetApp"^] en un archivo comprimido tar.gz.
