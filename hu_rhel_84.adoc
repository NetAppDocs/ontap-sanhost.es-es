...
---
= Utilice Red Hat Enterprise Linux 8,4 con ONTAP
:hardbreaks:
:toclevels: 1
:allow-uri-read: 
:toclevels: 1
...
[role="lead"]
Puede utilizar los ajustes de configuración del host SAN de ONTAP para configurar Red Hat Enterprise Linux 8,4 con ONTAP como destino.
...
No existen problemas conocidos para la versión de RHEL 8,4 con ONTAP.
