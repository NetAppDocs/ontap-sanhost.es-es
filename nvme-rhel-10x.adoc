...
En RHEL 10.0, la iopolicy predeterminada es round-robin, pero queue-depth está disponible como opción configurable. Si usas RHEL 10.0, puedes cambiar la iopolicy a queue-depth modificando el archivo de reglas de udev.
