...
+
** Evite emitir el  `nvme disconnect-all` comando en sistemas que arrancan desde SAN a través de espacios de nombres NVMe-TCP o NVMe-FC, ya que desconecta los sistemas de archivos raíz y de datos y podría generar inestabilidad en el sistema.
