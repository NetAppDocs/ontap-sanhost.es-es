...
.Pasos
. Verifique la siguiente configuración de NVMe/FC en el host Oracle Liniux 9,5:
+
.. Verifique que "multipath" esté configurado:
+
[source, cli]
----
...
----
+
El valor  `Y` verifica que el parámetro multitrayecto esté configurado.
