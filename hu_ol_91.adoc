...
NOTE: Para configurar el kernel compatible con Red Hat (RHCK) de Oracle Linux 9,1, utilice para link:hu_rhel_91.html#recommended-settings["configuración recomendada"]Red Hat Enterprise Linux (RHEL) 9,1.
