...
NOTE: Para configurar Oracle Linux 9,1 RedHat Enterprise Kernel (RHCK), utilice link:hu_rhel_91.html#recommended-settings["configuración recomendada"] Para Red Hat Enterprise Linux (RHEL) 9,1.
