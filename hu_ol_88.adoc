...
NOTE: Para configurar Oracle Linux 8,8 RedHat Enterprise Kernel (RHCK), utilice link:hu_rhel_88.html#recommended-settings["configuración recomendada"] Para Red Hat Enterprise Linux (RHEL) 8,8.
