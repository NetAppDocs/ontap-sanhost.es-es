...
== Instalación de revisiones de Windows

Sugerimos el uso de *última actualización acumulativa* para instalarse en el servidor.
...
== Instalar las utilidades unificadas de host de Windows
