...
summary: Instala las utilidades de host Linux en un host Oracle Linux 10.x para gestionar operaciones de los protocolos FCP e iSCSI con LUN de ONTAP. 
---
= Configura Oracle Linux 10.x para FCP e iSCSI con almacenamiento ONTAP
:hardbreaks:
:toclevels: 1
:allow-uri-read: 
:toclevels: 1
...
[role="lead"]
El software Linux Host Utilities proporciona herramientas de gestión y diagnóstico para hosts Linux que están conectados al almacenamiento ONTAP. Cuando instalas Linux Host Utilities en un host Oracle Linux 10.x, puedes usar Host Utilities para ayudarte a gestionar las operaciones de los protocolos FCP e iSCSI con LUNs ONTAP.
...
Puedes usar multivía con Oracle Linux 10.x para gestionar los LUN de ONTAP.
