...
summary: Describe cómo usar Oracle Linux 6.5 con ONTAP 
---
= Uso de Oracle Linux 6.5 con NetApp ONTAP
:toc: macro
:hardbreaks:
:toclevels: 1
:allow-uri-read: 
...
Para Oracle Linux 6.5 debe existir el archivo /etc/multipath.conf, pero no es necesario realizar cambios específicos en el archivo. Oracle Linux 6.5 se ha compilado con todas las configuraciones necesarias para reconocer y gestionar correctamente las LUN de ONTAP. Para habilitar ALUA Handler, realice los siguientes pasos:
...
El sistema operativo Oracle Linux 6.5 se compila para reconocer las LUN de ONTAP y establecer automáticamente todos los parámetros de configuración correctamente.
...
NOTE: Para configurar Oracle Linux 6.5 RedHat Enterprise Kernel (RHCK), utilice link:hu_rhel_65.html#recommended-settings["configuración recomendada"] Para Red Hat Enterprise Linux (RHEL) 6.5.



== Problemas y limitaciones conocidos

No hay problemas conocidos de Oracle 6.5.


NOTE: Para ver los problemas conocidos de Oracle Linux (kernel compatible con Red Hat), consulte link:hu_rhel_65.html#known-problems-and-limitations["problemas conocidos"] Para Red Hat Enterprise Linux (RHEL) 6.5.
