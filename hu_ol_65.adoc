...
NOTE: Para configurar el kernel compatible con Red Hat (RHCK) de Oracle Linux 6,5, utilice para link:hu_rhel_65.html#recommended-settings["configuración recomendada"]Red Hat Enterprise Linux (RHEL) 6,5.
...
NOTE: Para obtener información sobre problemas conocidos de Oracle Linux RHCK, consulte link:hu_rhel_65.html#known-problems-and-limitations["problemas conocidos"]para RHEL 6,5.
