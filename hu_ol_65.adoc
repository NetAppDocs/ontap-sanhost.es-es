...
---
= Utilice Oracle Linux 6,5 con ONTAP
:hardbreaks:
:toclevels: 1
:allow-uri-read: 
:toclevels: 1
...
[role="lead"]
Es posible usar las opciones de configuración del host SAN de ONTAP para configurar Oracle Linux 6,5 con ONTAP como destino.
...
.Lo que necesitará
Si decide utilizar el arranque SAN, debe ser compatible con su configuración. Puede utilizar el https://mysupport.netapp.com/matrix/imt.jsp?components=68083;67438;67437;&solution=1&isHWU&src=IMT["Herramienta de matriz de interoperabilidad de NetApp"^] Para verificar si el sistema operativo, el HBA, el firmware del HBA y la BIOS de arranque del HBA y las versiones de ONTAP son compatibles.
...
NOTE: Para configurar Oracle Linux 6,5 Red Hat Enterprise Kernel (RHCK), utilice para link:hu_rhel_65.html#recommended-settings["configuración recomendada"]Red Hat Enterprise Linux (RHEL) 6,5.



== Problemas conocidos

No existen problemas conocidos para la versión Oracle Linux 6,5 con ONTAP.
