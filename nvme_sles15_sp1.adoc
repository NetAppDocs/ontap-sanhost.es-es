...
Ninguno. Las secuencias de comandos de conexión automática NVMe/FC nativas se incluyen en el paquete nvme-cli. Puede utilizar el controlador lpfc nativo de la bandeja de entrada en SLES15 SP1.
