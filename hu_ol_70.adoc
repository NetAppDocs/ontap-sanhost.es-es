...
summary: Instale Linux Host Utilities en un host Oracle Linux 7.0 para administrar operaciones de protocolo FCP e iSCSI con LUN de ONTAP. 
---
...
NOTE: Puedes utilizar el link:hu_rhel_70.html#rhel-rhck["Configuración recomendada para Red Hat Enterprise Linux (RHEL) 7.0"] para configurar Red Hat Compatible Kernel para Oracle Linux 7.0.
