...
summary: Instale las utilidades de host de Linux en SUSE Linux Enterprise Server 15 SP6 para gestionar las operaciones de protocolo FCP e iSCSI con LUN de ONTAP. 
---
