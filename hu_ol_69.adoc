...
---
= Uso de Oracle Linux 6.9 con NetApp ONTAP
:toc: macro
:hardbreaks:
:toclevels: 1
:allow-uri-read: 
...
NOTE: Para configurar Oracle Linux 6.9 RedHat Enterprise Kernel (RHCK), utilice link:hu_rhel_69.html#recommended-settings["configuración recomendada"] Para Red Hat Enterprise Linux (RHEL) 6.9.
...
NOTE: Para ver los problemas conocidos de Oracle Linux (kernel compatible con Red Hat), consulte link:hu_rhel_69.html#known-problems-and-limitations["problemas conocidos"] Para Red Hat Enterprise Linux (RHEL) 6.9.
