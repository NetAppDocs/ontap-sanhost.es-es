...
NOTE: Para configurar Oracle Linux 6,9 Red Hat Enterprise Kernel (RHCK), utilice para link:hu_rhel_69.html#recommended-settings["configuración recomendada"]Red Hat Enterprise Linux (RHEL) 6,9.
