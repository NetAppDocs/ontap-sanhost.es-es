...
NOTE: Para configurar Oracle Linux 8.5 RedHat Enterprise Kernel (RHCK), utilice link:hu_rhel_85.html#recommended-settings["configuración recomendada"] Para Red Hat Enterprise Linux (RHEL) 8.5.
