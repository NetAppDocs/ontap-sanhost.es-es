...
NOTE: Para configurar el kernel compatible con Red Hat (RHCK) de Oracle Linux 8,5, utilice para link:hu_rhel_85.html#recommended-settings["configuración recomendada"]Red Hat Enterprise Linux (RHEL) 8,5.
...
NOTE: Para obtener información sobre los problemas conocidos de RHCK de Oracle Linux, consulte la link:hu_rhel_85.html#known-problems-and-limitations["problemas conocidos"] sección de la documentación de la versión de RHEL correspondiente.
