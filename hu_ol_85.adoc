...
summary: Instale Linux Host Utilities en un host Oracle Linux 8.5 para administrar operaciones de protocolo FCP e iSCSI con LUN de ONTAP. 
---
= Configurar Oracle Linux 8.5 para FCP e iSCSI con almacenamiento ONTAP
:hardbreaks:
:toclevels: 1
:allow-uri-read: 
:toclevels: 1
...
[role="lead"]
El software de utilidades de host Linux proporciona herramientas de gestión y diagnóstico para hosts Linux que se conectan al almacenamiento de ONTAP. Al instalar las utilidades de host de Linux en un host de Oracle Linux 8.5, puede usarlas para ayudarlo a administrar las operaciones de protocolo FCP e iSCSI con LUN de ONTAP.
...
Puede utilizar el acceso multivía con Oracle Linux 8,5 para gestionar los LUN de ONTAP.


NOTE: Puedes utilizar el link:hu_rhel_85.html#rhel-rhck["Configuración recomendada para Red Hat Enterprise Linux (RHEL) 8.5"] para configurar Red Hat Compatible Kernel para Oracle Linux 8.5.
...
NOTE: Para obtener información sobre los problemas conocidos de Oracle Linux RHCK, consulte la link:hu_rhel_85.html#known-problems-and-limitations["problemas conocidos"] sección de la documentación de la versión de Red Hat Enterprise Linux correspondiente.
