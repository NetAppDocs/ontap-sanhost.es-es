...
* La compatibilidad con ESXi 7.0 U3 (y posterior) con NVMe/FC está disponible a partir de ONTAP 9.9.1 P3 y versiones posteriores debido a que las correcciones principales de NVMe abortado (emitidas por ESXi 7.0 U3 y posteriores) están disponibles a partir de ONTAP 9.9.1 P3. Consulte el informe público burt correspondiente en https://[] para obtener más detalles.
