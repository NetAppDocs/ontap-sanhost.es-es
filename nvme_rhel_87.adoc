...
. Una vez finalizada la instalación, compruebe que está ejecutando el kernel RHEL 8,7 especificado. Consulte link:https://mysupport.netapp.com/matrix/["Herramienta de matriz de interoperabilidad"^]la para obtener la lista actual de versiones compatibles.
+
Ejemplo:
...
--
El controlador de la bandeja de entrada nativo `qla2xxx` que se incluye en el kernel RHEL 8,7 tiene las correcciones más recientes. Estas correcciones son esenciales para la compatibilidad con ONTAP.
