...
Para conocer los problemas conocidos del kernel compatible con CentOS Red Hat, consulte la link:hu-rhel-8x.html#known-problems-and-limitations["problemas conocidos"] para la serie Red Hat Enterprise Linux (RHEL) 8.x.
