...
=== Reinstalación de invitados de GRUB para Linux tras corregir la alineación de MBR con el kit de herramientas PowerShell
...
No hay problemas conocidos para Windows Server 2012 R2.
