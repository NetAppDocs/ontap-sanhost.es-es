...
[role="lead"]
Puede utilizar los ajustes de configuración del host SAN de ONTAP para configurar Red Hat Enterprise Linux 6,9 con ONTAP como destino.
...
La versión de RHEL 6,9 con ONTAP tiene los siguientes problemas conocidos:
