...
NOTE: Para configurar Oracle Linux 9,4 Red Hat Enterprise Kernel (RHEK), utilice para link:hu_rhel_94.html#recommended-settings["configuración recomendada"]Red Hat Enterprise Linux (RHEL) 9,4.
