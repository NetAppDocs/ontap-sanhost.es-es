...
--
.Pasos
. El controlador de la bandeja de entrada nativa qla2xxx que se incluye en el kernel OL 8,8 GA tiene las últimas correcciones esenciales para la compatibilidad con ONTAP. Compruebe que está ejecutando las versiones de firmware y controlador del adaptador compatibles:
+
[listing]
----
