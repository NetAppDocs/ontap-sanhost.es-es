...
summary: Instale Linux Host Utilities en un host Rocky Linux 8.10 para administrar operaciones de protocolo FCP e iSCSI con LUN de ONTAP. 
---
= Configurar Rocky Linux 8.x para FCP e iSCSI con almacenamiento ONTAP
:hardbreaks:
:toclevels: 1
:allow-uri-read: 
:toclevels: 1
...
[role="lead"]
El software Linux Host Utilities proporciona herramientas de administración y diagnóstico para los hosts Linux que están conectados al almacenamiento ONTAP . Cuando instale Linux Host Utilities en un host Rocky Linux 8.x, podrá utilizar Host Utilities para ayudarle a gestionar las operaciones de los protocolos FCP e iSCSI con LUN de ONTAP .
...
Puedes utilizar multipathing con Rocky Linux 8.x para gestionar LUN de ONTAP .
