...
NOTE: Para configurar Oracle Linux 8,3 Red Hat Enterprise Kernel (RHCK), utilice para link:hu_rhel_83.html#recommended-settings["configuración recomendada"]Red Hat Enterprise Linux (RHEL) 8,3.
...
NOTE: Para obtener información sobre problemas conocidos de Oracle Linux (kernel compatible con Red Hat), consulte link:hu_rhel_83.html#known-problems-and-limitations["problemas conocidos"]la sección en la documentación de la versión de Red Hat Enterprise Linux correspondiente.
