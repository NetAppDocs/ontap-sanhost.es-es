...
NOTE: Para configurar el kernel compatible con Red Hat (RHCK) de Oracle Linux 7,9, utilice para link:hu_rhel_79.html#recommended-settings["configuración recomendada"]Red Hat Enterprise Linux (RHEL) 7,9.
