...
summary: Instale Linux Host Utilities en un host Oracle Linux 7.9 para administrar operaciones de protocolo FCP e iSCSI con LUN de ONTAP. 
---
= Configurar Oracle Linux 7.9 para FCP e iSCSI con almacenamiento ONTAP
:hardbreaks:
:toclevels: 1
:allow-uri-read: 
:toclevels: 1
...
[role="lead"]
El software de utilidades de host Linux proporciona herramientas de gestión y diagnóstico para hosts Linux que se conectan al almacenamiento de ONTAP. Al instalar las utilidades de host de Linux en un host Oracle Linux 7.9, puede usar las utilidades de host para ayudarlo a administrar las operaciones de protocolo FCP e iSCSI con LUN de ONTAP.
...
Puede utilizar el acceso multivía con Oracle Linux 7,9 para gestionar los LUN de ONTAP.


NOTE: Puedes utilizar el link:hu_rhel_79.html#rhel-rhck["Configuración recomendada para Red Hat Enterprise Linux (RHEL) 7.9"] para configurar Red Hat Compatible Kernel para Oracle Linux 7.9.
...
El host Oracle Linux 7.9 con almacenamiento ONTAP tiene los siguientes problemas conocidos:
