...
--
El controlador de la bandeja de entrada nativa qla2xxx que se incluye en el kernel GA de RHEL 9,2 tiene las correcciones más recientes. Estas correcciones son esenciales para la compatibilidad con ONTAP.
