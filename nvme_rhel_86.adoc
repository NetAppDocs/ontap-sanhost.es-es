...
Consulte la link:https://mysupport.netapp.com/matrix/["Herramienta de matriz de interoperabilidad"^] para obtener información precisa sobre las configuraciones compatibles.
...
.Pasos
. Instale RHEL 8,6 en el servidor. Una vez finalizada la instalación, compruebe que está ejecutando el kernel RHEL 8,6 especificado. Consulte link:https://mysupport.netapp.com/matrix/["Herramienta de matriz de interoperabilidad"^]la para obtener la lista actual de versiones compatibles.
. Una vez finalizada la instalación, compruebe que está ejecutando el kernel RHEL 8,6 especificado. Consulte link:https://mysupport.netapp.com/matrix/["Herramienta de matriz de interoperabilidad"^]la para obtener la lista actual de versiones compatibles.
+
Ejemplo:
