...
---
= Uso de Oracle Linux 7.2 con NetApp ONTAP
:toc: macro
:hardbreaks:
:toclevels: 1
:allow-uri-read: 
...
NOTE: Para configurar Oracle Linux 7.2 RedHat Enterprise Kernel (RHCK), utilice link:hu_rhel_72.html#recommended-settings["configuración recomendada"] Para Red Hat Enterprise Linux (RHEL) 7.2.



== Problemas y limitaciones conocidos

No existen problemas conocidos para Oracle Linux 7.2.
