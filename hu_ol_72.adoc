...
NOTE: Para configurar el kernel compatible con Red Hat (RHCK) de Oracle Linux 7,2, utilice para link:hu_rhel_72.html#recommended-settings["configuración recomendada"]Red Hat Enterprise Linux (RHEL) 7,2.
