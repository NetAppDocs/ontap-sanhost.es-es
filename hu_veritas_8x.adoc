...
---
= Uso de Veritas Infoscale 8 para Linux con ONTAP de NetApp
:toc: macro
:hardbreaks:
:toclevels: 1
:allow-uri-read: 
...
En este documento se ofrecen directrices sobre los ajustes de configuración del host SAN de ONTAP para el lanzamiento de la base de almacenamiento Veritas Infoscale de la serie 8 para plataformas Red Hat Enterprise Linux y Oracle Linux (basadas en RHCK) con protocolos FC, FCoE e iSCSI.
