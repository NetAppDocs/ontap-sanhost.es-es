...
summary: Configure Ubuntu 22.04 para rutas múltiples y con parámetros y configuraciones específicos para la operación FCP e iSCSI con almacenamiento ONTAP . 
---
...
[role="lead"]
Configure Ubuntu 24.04 para rutas múltiples y con parámetros y configuraciones específicos para la operación FCP e iSCSI con almacenamiento ONTAP .
