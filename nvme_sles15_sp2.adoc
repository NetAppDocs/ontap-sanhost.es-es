...
----
. En el host SUSE Linux Enterprise Server 15 SP2, compruebe la cadena NQN del host en `/etc/nvme/hostnqn` y verifique que coincida con la cadena NQN del host para el subsistema correspondiente en la matriz de ONTAP. Por ejemplo:
+
[listing]
----
