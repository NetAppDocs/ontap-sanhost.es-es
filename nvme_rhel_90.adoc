...
--
.Pasos
. Compruebe que está utilizando el adaptador compatible. Para obtener más información sobre los adaptadores compatibles, consulte link:https://mysupport.netapp.com/matrix/["Herramienta de matriz de interoperabilidad de NetApp"^].
+
[listing]
----
...
.Marvell/QLogic
--
El controlador de la bandeja de entrada nativa qla2xxx que se incluye en el kernel RHEL 9,0 tiene las últimas correcciones, esenciales para la compatibilidad con ONTAP.
