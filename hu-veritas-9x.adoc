...
summary: Utilice Linux Host Utilities con Veritas Infoscale 9 para hosts RHEL y Oracle Linux para ayudarlo a administrar operaciones de protocolo FC, FCoE e iSCSI con LUN de ONTAP . 
---
= Configurar Veritas Infoscale 9 para FC, FCoE e iSCSI con almacenamiento ONTAP
:hardbreaks:
:toclevels: 1
:allow-uri-read: 
:toclevels: 1
...
Utilice Veritas Dynamic Multipathing (VxDMP) con Veritas Infoscale 9 para administrar LUN de ONTAP .
