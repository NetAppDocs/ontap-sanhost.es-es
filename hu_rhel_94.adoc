...
summary: Instale Linux Host Utilities en un host RHEL 9.4 para administrar operaciones de protocolo FCP e iSCSI con LUN de ONTAP. 
---
= Configurar RHEL 9,4 para FCP e iSCSI con almacenamiento de ONTAP
:hardbreaks:
:toclevels: 1
:allow-uri-read: 
:toclevels: 1
...
Es posible utilizar accesos múltiples con RHEL 9,4 para administrar los LUN de ONTAP.
