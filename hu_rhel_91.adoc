...
.Lo que necesitará
Si tiene una versión de Linux Unified Host Utilities instalada actualmente, debe actualizar o quitar la versión y usar los siguientes pasos para instalar la versión más reciente.
