...
summary: Instale Linux Host Utilities en un host CentOS 8.0 para administrar operaciones de protocolo FCP e iSCSI con LUN de ONTAP . 
---
= Configurar CentOS 8.0 para FCP e iSCSI para almacenamiento ONTAP
:hardbreaks:
:toclevels: 1
:allow-uri-read: 
:toclevels: 1
...
[role="lead"]
El software de utilidades de host Linux proporciona herramientas de gestión y diagnóstico para hosts Linux que se conectan al almacenamiento de ONTAP. Cuando instala las utilidades de host de Linux en un host CentOS 8.0, puede usarlas para ayudarlo a administrar las operaciones de protocolo FCP e iSCSI con LUN de ONTAP.
...
Puede utilizar rutas múltiples con CentOS 8.0 para administrar LUN de ONTAP.
...
No hay problemas conocidos para CentOS 8.0 para FCP e iSCSI con almacenamiento ONTAP.

Para conocer los problemas conocidos del kernel compatible con CentOS Red Hat, consulte link:hu_rhel_80.html#known-problems-and-limitations["problemas conocidos"] para Red Hat Enterprise Linux (RHEL) 8.0.
