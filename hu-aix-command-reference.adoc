...
---
= Utilice los comandos de AIX Host Utilities para verificar la configuración de almacenamiento de ONTAP
:hardbreaks:
:toclevels: 1
:allow-uri-read: 
:toclevels: 1
...
.8.0
--
.Mostrar ejemplo para AIX Host Utilities 8.0
[%collapsible]
=====
[listing]
----
...
.7.0 y 6.1
--
.Mostrar ejemplo para AIX Host Utilities 7.0 y 6.1
[%collapsible]
=====
[listing]
----
