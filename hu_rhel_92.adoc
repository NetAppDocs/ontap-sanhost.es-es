...
summary: Instale Linux Host Utilities en un host RHEL 9.2 para administrar operaciones de protocolo FCP e iSCSI con LUN de ONTAP. 
---
= Configurar RHEL 9,2 para FCP e iSCSI con almacenamiento de ONTAP
:hardbreaks:
:toclevels: 1
:allow-uri-read: 
:toclevels: 1
...
Es posible utilizar accesos múltiples con RHEL 9,2 para administrar los LUN de ONTAP.
...
La versión de almacenamiento de RHEL 9,2 con ONTAP tiene el siguiente problema conocido:
