...
---
= Utilice Oracle Linux 6,8 con ONTAP
:hardbreaks:
:toclevels: 1
:allow-uri-read: 
:toclevels: 1
...
[role="lead"]
Es posible usar las opciones de configuración del host SAN de ONTAP para configurar Oracle Linux 6,8 con ONTAP como destino.
...
NOTE: Para configurar Oracle Linux 6,8 Red Hat Enterprise Kernel (RHCK), utilice para link:hu_rhel_68.html#recommended-settings["configuración recomendada"]Red Hat Enterprise Linux (RHEL) 6,8.



== Problemas conocidos

No existen problemas conocidos para la versión Oracle Linux 6,8 con ONTAP.
