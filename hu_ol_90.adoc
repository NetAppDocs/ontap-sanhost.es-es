...
En las siguientes secciones se proporcionan ejemplos de salidas multivía para una LUN asignada a personas de interés ASA y no ASA.
...
NOTE: Para configurar el kernel compatible con Red Hat (RHCK) de Oracle Linux 9,0, utilice para link:hu_rhel_86.html#recommended-settings["configuración recomendada"]Red Hat Enterprise Linux (RHEL) 9,0.
