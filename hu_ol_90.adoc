...
El kit de herramientas se instala automáticamente cuando instala el paquete de utilidades de host de NetApp. Este kit proporciona la utilidad sanlun, que le ayuda a gestionar LUN y HBA. El comando sanlun muestra información acerca de las LUN asignadas al host, la multivía y la información necesaria para crear iGroups.

En el ejemplo siguiente, el comando sanlun lun show muestra información de las LUN.
...
No hay problemas conocidos para Oracle Linux 9,0.
