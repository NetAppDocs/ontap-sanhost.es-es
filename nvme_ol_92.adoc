...
--
.Pasos
. El controlador de la bandeja de entrada nativa qla2xxx que se incluye en el kernel OL 9,2 GA tiene las correcciones de subida más recientes esenciales para la compatibilidad con ONTAP. Compruebe que está ejecutando las versiones de firmware y controlador del adaptador compatibles:
+
[listing]
----
