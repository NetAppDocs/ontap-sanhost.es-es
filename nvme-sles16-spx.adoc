...
.NVMe/FC
--
Los siguientes ejemplos de salida muestran un espacio de nombres alojado en un controlador ONTAP de dos nodos para AFF, FAS, ASA o ASA r2 con NVMe/FC.
...
.NVMe/TCP
--
Los siguientes ejemplos de salida muestran un espacio de nombres alojado en un controlador ONTAP de dos nodos para sistemas AFF, FAS, ASA o ASA r2 con NVMe/TCP.
...
----
====
.. Exporta el TLS PSK del llavero del kernel. Esto asegura que la clave persista durante un reinicio del host:
+
[source, cli]
----
