...
NOTE: Para configurar el kernel compatible con Red Hat (RHCK) de Oracle Linux 7,7, utilice para link:hu_rhel_77.html#recommended-settings["configuración recomendada"]Red Hat Enterprise Linux (RHEL) 7,7.
