...
NOTE: Para configurar Oracle Linux 7,7 Red Hat Enterprise Kernel (RHCK), utilice para link:hu_rhel_77.html#recommended-settings["configuración recomendada"]Red Hat Enterprise Linux (RHEL) 7,7.
