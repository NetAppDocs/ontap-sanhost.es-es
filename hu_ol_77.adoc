...
---
= Uso de Oracle Linux 7.7 con NetApp ONTAP
:toc: macro
:hardbreaks:
:toclevels: 1
:allow-uri-read: 
...
El sistema operativo Oracle Linux 7,7 se compila para reconocer los LUN de ONTAP y definir automáticamente todos los parámetros de configuración correctamente.
...
NOTE: Para configurar Oracle Linux 7.7 RedHat Enterprise Kernel (RHCK), utilice link:hu_rhel_77.html#recommended-settings["configuración recomendada"] Para Red Hat Enterprise Linux (RHEL) 7.7.
