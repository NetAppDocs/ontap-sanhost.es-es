...
---
= Uso de Oracle Linux 7.8 con NetApp ONTAP
:toc: macro
:hardbreaks:
:toclevels: 1
:allow-uri-read: 
...
El sistema operativo Oracle Linux 7,8 se compila para reconocer los LUN de ONTAP y definir automáticamente todos los parámetros de configuración correctamente.
...
NOTE: Para configurar Oracle Linux 7.8 RedHat Enterprise Kernel (RHCK), utilice link:hu_rhel_78.html#recommended-settings["configuración recomendada"] Para Red Hat Enterprise Linux (RHEL) 7.8.
