...
---
= Uso de Oracle Linux 8.4 con NetApp ONTAP
:toc: macro
:hardbreaks:
:toclevels: 1P
:allow-uri-read: 
...
NOTE: Para configurar Oracle Linux 8.4 RedHat Enterprise Kernel (RHCK), utilice link:hu_rhel_84.html#recommended-settings["configuración recomendada"] Para Red Hat Enterprise Linux (RHEL) 8.4.
...
No existen problemas conocidos para Oracle Linux 8.4.


NOTE: Para ver los problemas conocidos de Oracle Linux (kernel compatible con Red Hat), consulte link:hu_rhel_84.html#known-problems-and-limitations["problemas conocidos"] En la documentación correspondiente de la versión de Red Hat Enterprise Linux.
