...
---
= Uso de SUSE Linux Enterprise Server 12 SP2 con ONTAP de NetApp
:toc: macro
:hardbreaks:
:toclevels: 1
:allow-uri-read: 
...
SUSE Linux Enterprise Server 12 SP2 OS se compila para reconocer los LUN de ONTAP y definir automáticamente todos los parámetros de configuración correctamente.
...
No hay problemas conocidos para SUSE Linux Enterprise Server 12 SP2.
