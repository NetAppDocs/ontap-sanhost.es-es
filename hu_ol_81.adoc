...
NOTE: Para configurar el kernel compatible con Red Hat (RHCK) de Oracle Linux 8,1, utilice para link:hu_rhel_81.html#recommended-settings["configuración recomendada"]Red Hat Enterprise Linux (RHEL) 8,1.
...
NOTE: Para obtener información sobre problemas conocidos de Oracle Linux RHCK, consulte link:hu_rhel_81.html#known-problems-and-limitations["problemas conocidos"]para RHEL 8,1.
