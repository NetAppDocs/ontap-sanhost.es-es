...
NOTE: Para configurar Oracle Linux 8,1 Red Hat Enterprise Kernel (RHCK), utilice para link:hu_rhel_81.html#recommended-settings["configuración recomendada"]Red Hat Enterprise Linux (RHEL) 8,1.
...
NOTE: Para problemas conocidos de Oracle Linux (kernel compatible con Red Hat), consulte link:hu_rhel_81.html#known-problems-and-limitations["problemas conocidos"]para Red Hat Enterprise Linux (RHEL) 8,1.
