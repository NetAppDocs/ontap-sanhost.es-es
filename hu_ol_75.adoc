...
NOTE: Para configurar Oracle Linux 7.5 RedHat Enterprise Kernel (RHCK), utilice link:hu_rhel_75.html#recommended-settings["configuración recomendada"] Para Red Hat Enterprise Linux (RHEL) 7.5.
