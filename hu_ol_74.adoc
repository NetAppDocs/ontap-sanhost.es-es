...
NOTE: Para configurar Oracle Linux 7.4 RedHat Enterprise Kernel (RHCK), utilice link:hu_rhel_74.html#recommended-settings["configuración recomendada"] Para Red Hat Enterprise Linux (RHEL) 7.4.
