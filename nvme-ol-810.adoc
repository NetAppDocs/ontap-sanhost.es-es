...
[role="lead"]
Las configuraciones de hosts SAN de NetApp admiten el protocolo NVMe over Fabrics (NVMe-oF) en Oracle Linux 8,10 con acceso asimétrico a espacio de nombres (ANA).
...
----
+
Para obtener la lista actual de versiones de firmware y controladores de adaptador compatibles, consulte la link:https://mysupport.netapp.com/matrix/["Herramienta de matriz de interoperabilidad de NetApp"^].
