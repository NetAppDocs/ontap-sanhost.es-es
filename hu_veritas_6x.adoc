...
---
= Uso de Veritas Storage Foundation 6 para Linux con ONTAP de NetApp
:toc: macro
:hardbreaks:
:toclevels: 1
:allow-uri-read: 
...
Este documento proporciona directrices sobre los ajustes de configuración de host SAN de ONTAP para la versión de Veritas Storage Foundation 6 para plataformas Red Hat Enterprise Linux y Oracle Linux (basadas en RHCK) con protocolos FC, FCoE e iSCSI.
...
Debe verificar que la configuración cumple los requisitos del sistema. Para obtener más información, consulte https://["Herramienta de matriz de interoperabilidad de NetApp"^] Y la matriz Veritas HCL.
