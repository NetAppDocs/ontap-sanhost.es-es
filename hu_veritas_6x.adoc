...
---
= Configurar Veritas Infoscale 6 para FC, FCoE e iSCSI con almacenamiento ONTAP
:hardbreaks:
:toclevels: 1
:allow-uri-read: 
:toclevels: 1
...
Utilice Veritas Dynamic Multipathing (VxDMP) con Veritas Infoscale 6 para administrar LUN de ONTAP .
