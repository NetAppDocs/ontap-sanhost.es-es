...
summary: Describe cómo usar Oracle Linux 8.x con ONTAP. 
---
= Configurar Oracle Linux 8.x para FCP e iSCSI con almacenamiento ONTAP
:hardbreaks:
:toclevels: 1
:allow-uri-read: 
:toclevels: 1
...
[role="lead"]
El software Linux Host Utilities proporciona herramientas de administración y diagnóstico para los hosts Linux que están conectados al almacenamiento ONTAP . Cuando instale las utilidades de host de Linux en un host Oracle Linux 8.x, podrá utilizarlas para ayudarle a gestionar las operaciones de los protocolos FCP e iSCSI con LUN de ONTAP .
...
Puede utilizar rutas múltiples con Oracle Linux 8.x para administrar LUN de ONTAP .


NOTE: Puedes usar el link:hu-rhel-8x.html#rhel-rhck["Configuración recomendada para Red Hat Enterprise Linux (RHEL) 8.x"] Configurar el kernel compatible con Red Hat para Oracle Linux 8.x.
