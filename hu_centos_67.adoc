...
Para ver problemas conocidos de CentOS (kernel compatible con Red Hat), consulte link:hu_rhel_67.html#known-problems-and-limitations["problemas conocidos"]para Red Hat Enterprise Linux (RHEL) 6,7.
