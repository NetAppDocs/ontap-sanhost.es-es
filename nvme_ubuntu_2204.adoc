...
--
.Pasos
. El controlador de bandeja de entrada nativa qla2xxx incluido en el kernel Ubuntu 22,04 GA tiene las últimas correcciones de subida esenciales para el soporte de ONTAP. Compruebe que está ejecutando las versiones de firmware y controlador del adaptador compatibles:
+
[listing]
----
...
No son problemas conocidos para la configuración de host NVMe-oF para Ubuntu 22,04 con ONTAP release.
