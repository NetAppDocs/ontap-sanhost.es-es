...
summary: Instala las utilidades de host de Linux en un host Ubuntu 22.04 para gestionar las operaciones de los protocolos FCP e iSCSI con los LUN de ONTAP. 
---
= Configurar Ubuntu 22.04 para FCP e iSCSI con almacenamiento ONTAP
:hardbreaks:
:toclevels: 1
:allow-uri-read: 
:toclevels: 1
...
Puede utilizar rutas múltiples con Ubuntu 22.04 para administrar LUN de ONTAP .
